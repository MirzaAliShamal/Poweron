...
@section('breadcrumb')
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        ...
        <li class="breadcrumb-item text-dark">Email Templates</li>
    </ul>
@endsection
    ...
    <div class="card">
        <div class="card-header border-0 pt-5">
            ...
            <div class="card-toolbar">
                <a href="{{ route('email.templates.add') }}" class="btn btn-sm btn-primary">Add New</a>
            </div>
        </div>
...
@section('js')
    <script src="{{ asset('assets/js/emailTemplates/index.js?v='.rand()) }}"></script>
@endsection
