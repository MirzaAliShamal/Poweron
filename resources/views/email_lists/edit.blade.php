...
@section('content')
    <div class="card">
        ...
        <div class="card-body py-10">
            <form action="{{ route('email.lists.update', $emailList->id) }}" method="POST" class="edit-form">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="form-group mb-5">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="John Doe" value="{{ old('name', $emailList->name) }}"
                            />
                        </div>
                    </div>
...
@section('js')
    ...
    <script src="{{ asset('assets/js/emailLists/edit.js?v='.rand()) }}"></script>
@endsection
